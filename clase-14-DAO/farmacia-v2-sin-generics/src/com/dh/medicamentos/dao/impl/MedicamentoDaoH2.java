...
public class MedicamentoDaoH2 implements IDaoMedicamento {

    private final static String DB_JDBC_DRIVER = "org.h2.Driver";
    // con la instruccion INIT=RUNSCRIPT cuando se conecta a la base
    // ejecuta el script de sql (create.sql) que esta en la raiz del proyecto
    ...
    public Medicamento guardar(Medicamento medicamento) {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement(
                    "INSERT INTO medicamentos(nombre,laboratorio,cantidad,precio) VALUES(?,?,?,?)");
            //No le vamos a pasar el ID ya que hicimos que fuera autoincremental en la base de datos
            // Esto lo podemos ver en el archivo 'create.sql'
